...
public class kkk {
    ...
    static boolean sudahBayarKernjngTiket = false;
    static boolean sudahBayarKernjngSnack = false;
                        ...
                        switch (choice) {
                            ...
                            case 4:
                                if (isLoggedIn) {
                                    ...
                                    for (int i = adminInput; i <= 6 + adminInput; i++) {
                                        ...
                                        System.out.println("||   " + i + "    || " + bulan[adminBulan - 1] + " ||  "
                                                + tahun + " ||");
                            ...
                            case 7:
                                if (isLoggedIn) {
                                    ...
                                    if (isTiketKeranjang) {
                                        ...
                                        System.out.println("Harga 1 Tiket : Rp25.000");
                                        if (isMember) {
                                            System.out.println("Diskon : 10%");
                                        }
                                        hargaTiket();
                                    ...
                                    if (isTiketKeranjang || isSnackKeranjang) {
                                        ...
                                        while (true) {
                                            ...
                                            if (case7 == 1) {
                                                ...
                                                sudahBayar = true;
                                                if (isSnackKeranjang) {
                                                    sudahBayarKernjngSnack = true;
                                                }
                                                if (isTiketKeranjang) {
                                                    sudahBayarKernjngTiket = true;
                                                }
                                                break;
                                            } else if (case7 == 2) {
                                                break;
                            ...
                            case 8:
                                if (sudahBayar) {
                                    ...
                                    System.out.println("Jumlah Kursi : " + bnykKursi);
                                    hargaTiket();
                                    if (sudahBayarKernjngTiket || sudahBayarTiket) {
                                    ...
                                    System.out.println("Jumlah Item : " + quantity);
                                    System.out.println("Total Biaya : Rp." + totalCost);
                                    if (sudahBayarKernjngSnack || sudahBayarSnack) {
                                        System.out.println("Status: Sudah Dibayar!\n");
    ...
    static void showMenuSudahLogin() {
        ...
        System.out.println("[2] Beli Snack dan Minuman");
